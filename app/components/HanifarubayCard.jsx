...
export default function HanifarubayCard() {
  ...
  return (
    <div>
        {isMobile ? <Image src={hanifarubay} alt='Hanifaru bay image' className='w-full h-auto'/> : 
        <Image src={mantaPic} alt='Hanifaru bay image' className='w-full h-auto' />
        }
        <div className='px-6 mb-0 md:mb-2 w-screen'>
        <h5 className='text-5xl md:text-8xl mb-4 font-medium md:font-bold text-white text-center [text-shadow:_4px_1px_2px_rgb(0_0_0_/_60%)] -mt-14 md:-mt-24'>Hanifaru Bay</h5>
