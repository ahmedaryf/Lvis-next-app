...
export default function HanifarubayCard() {
  ...
  return (
    <div>
        ...
        <h5 className='text-5xl md:text-8xl mb-4 font-medium md:font-bold text-white text-center [text-shadow:_4px_1px_2px_rgb(0_0_0_/_60%)] -mt-8 md:-mt-14'>Hanifaru Bay</h5>
